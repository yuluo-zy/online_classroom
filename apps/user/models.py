...
class UserProfile(AbstractUser):
    ...
    address = models.CharField(max_length=105,default=u"",verbose_name=u"地址")
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(verbose_name=u"验证码类型",choices=(("register", u"注册"), ("forget", u"找回密码")),
                                 max_length=20)
    send_date = models.DateTimeField(default=datetime.now, verbose_name=u"添加数据时间")
...
class Banner(models.Model):
    ...
    index_num = models.IntegerField(default=100,verbose_name=u"顺序")
